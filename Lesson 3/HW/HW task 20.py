...
# J, X, Ш, Э, Ю = 8
# Q, Z, Ф, Щ, Ъ = 10
# word = input('Enter u word here: ')
# if word == A, E, I, O, U, L, N, S, T, R, А, В, Е, И, Н, О, 
# Р, С, Т, D, G, Д, К, Л, М, П, У, B, C, M, P, 
# Б, Г, Ё, Ь, Я, F, H, V, W, Y, Й, Ы, K, Ж, З, Х, 
# Ц, Ч, J, X, Ш, Э, Ю, Q, Z, Ф, Щ, Ъ:
